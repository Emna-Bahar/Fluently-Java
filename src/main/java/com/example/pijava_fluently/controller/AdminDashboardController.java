...
import javafx.scene.layout.BorderPane;  // ← Ajoutez cet import
...
public class AdminDashboardController {
    ...
    @FXML private BorderPane rootPane;  // ← Changez VBox en BorderPane
    @FXML private Button btnTheme;
    @FXML private Label pageTitle;
    @FXML private Label pageBreadcrumb;
    @FXML private Label adminName;
    @FXML private Label topbarUsername;
    @FXML private StackPane contentArea;  // ou le conteneur principal
    ...
    private void toggleTheme() {
        try {
            // Utilisez btnTheme pour obtenir la scène au lieu de rootPane
            if (btnTheme == null) {
                System.err.println("btnTheme est null");
                return;
            }
            ...
            if (darkCss == null) {
                System.err.println("Fichier dark.css introuvable");
                return;
            }
            ...
            if (sheets.contains(darkCss)) {
                ...
                btnTheme.setText("🌙");
                System.out.println("Mode clair activé");
            } else {
                sheets.add(darkCss);
                btnTheme.setText("☀️");
